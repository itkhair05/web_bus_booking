...
<head>
    ...
    <style>
        ...
        .simple-header .nav-links a.btn-primary {
...
<body>
    ...
    <div class="simple-header">
        <div class="logo">🚌 Bus Booking</div>
        <div class="nav-links">
            <a href="<?php echo appUrl(); ?>"><i class="fas fa-home"></i> Trang chủ</a>
            <a href="<?php echo appUrl('user/tickets/my_tickets.php'); ?>"><i class="fas fa-ticket-alt"></i> Vé của tôi</a>
            <a href="<?php echo appUrl('user/payments/history.php'); ?>"><i class="fas fa-receipt"></i> Lịch sử GD</a>
            <a href="<?php echo appUrl('user/notifications/index.php'); ?>">
                <i class="fas fa-bell"></i> Thông báo 
                <?php if ($unreadNotifications > 0): ?>
                    <span class="badge bg-danger"><?php echo $unreadNotifications; ?></span>
                <?php endif; ?>
            </a>
            <a href="<?php echo appUrl('user/auth/logout.php'); ?>" class="btn-primary"><i class="fas fa-sign-out-alt"></i> Đăng xuất</a>
        </div>
    </div>
    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-card">
            <h1>👋 Xin chào<?php echo !empty($user['name']) ? ', ' . e($user['name']) : ''; ?>!</h1>
                    ...
                    <div class="trip-item">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <div class="trip-route">
                                <?php 
                                $start = !empty($trip['start_point']) ? e($trip['start_point']) : 'Điểm đi';
                                $end = !empty($trip['end_point']) ? e($trip['end_point']) : 'Điểm đến';
                                echo $start;
                                ?> <i class="fas fa-arrow-right" style="font-size: 14px; color: var(--primary);"></i> <?php echo $end; ?>
                            </div>
                    ...
                    <div class="trip-item">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <div>
                                <div class="trip-route">
                                    <?php 
                                    $start = !empty($booking['start_point']) ? e($booking['start_point']) : 'Điểm đi';
                                    $end = !empty($booking['end_point']) ? e($booking['end_point']) : 'Điểm đến';
                                    echo $start;
                                    ?> <i class="fas fa-arrow-right" style="font-size: 14px; color: var(--primary);"></i> <?php echo $end; ?>
                                </div>
